...
| 2026-06-30 | Consolidate applicationStatus transition logic into one function (dedupe + fix drift) | backend | [#24](https://github.com/depa-platform/tdv-room-booking-backend/issues/24) | [#25](https://github.com/depa-platform/tdv-room-booking-backend/pull/25) | In Review | `requirements/2026-06-30/` (`*-consolidate-status-transition.md`), `issues/2026-06-30-consolidate-status-transition/` |
